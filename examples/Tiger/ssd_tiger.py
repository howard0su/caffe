...
train_data = "examples/Tiger/Tiger_trainval_lmdb"
...
model_name = "Tiger_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/Tiger/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/Tiger/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/Tiger/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/Tiger/results/{}/Main".format(os.environ['HOME'], job_name)
...
# Stores the test image names and sizes. Created by data/Tiger/create_list.sh
name_size_file = "data/Tiger/test_name_size.txt"
